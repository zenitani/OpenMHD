...
!  real(8), intent(out) :: V(ix,jx,var2)
  ...
  iix = npe*(ix-2)+2
  disp = 0
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  call mpi_file_read_all( fh,  t, 1,   mpi_real8, mpi_status_ignore, ierr) ; disp = disp+mk
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  call mpi_file_read_all( fh,iix0,1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mk
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  call mpi_file_read_all( fh,jx0, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mk
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  ...
  call mpi_file_read_all( fh, x, ix, mpi_real8, mpi_status_ignore, ierr) ; disp = disp+mk
  call mpi_file_set_view(fh, disp, mpi_byte, mpi_byte, "native", mpi_info_null, ierr)
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize

  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
  call mpi_file_read_all( fh, y, jx,   mpi_real8, mpi_status_ignore, ierr) ; disp = disp+mk
  call mpi_file_read_all( fh, mk, 1, mpi_integer, mpi_status_ignore, ierr) ; disp = disp+mksize
