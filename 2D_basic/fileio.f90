...
!
!  * fileio_output(filename,ix,jx,t,x,y,U,V)
!  * fileio_input(filename,ix,jx,t,x,y,U)
!
...
!     Output routine
! ----------------------------------------------------------------------
subroutine fileio_output(filename,ix,jx,t,x,y,U,V)
  implicit none
  include 'param.h'
...
!     Input routine
! ----------------------------------------------------------------------
subroutine fileio_input(filename,ix,jx,t,x,y,U)
  implicit none
  include 'param.h'
  character*256 :: filename      
  integer, intent(in) :: ix, jx
