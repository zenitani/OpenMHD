...
! BC for U
subroutine mpibc2_for_U(U,ix,jx)
  use parallel
  implicit none
  include 'param.h'
...
end subroutine mpibc2_for_U


! BC for F -- VL/VR in the X direction
subroutine mpibc2_for_F( VL,VR,ix,jx )
  use parallel
  implicit none
  include 'param.h'
  integer, intent(in) :: ix, jx
...
end subroutine mpibc2_for_F


! BC for G -- VL/VR in the Y direction
subroutine mpibc2_for_G( VL,VR,ix,jx )
  use parallel
  implicit none
  include 'param.h'
  integer, intent(in) :: ix, jx
