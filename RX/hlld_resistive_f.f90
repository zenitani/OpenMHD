subroutine hlld_resistive_f(F,U,VL,VR,EtS,dx,ix,jx)
!-----------------------------------------------------------------------
...
!$omp private(ro_L1,ro_R1,vy_L1,vy_R1,vz_L1,vz_R1,vy_2,vz_2,ro_Ls,ro_Rs)
  do j=1,jx
  do i=1,ix-1
...
!-----------------------------------------------------------------------
  ...
  return
end subroutine hlld_resistive_f
